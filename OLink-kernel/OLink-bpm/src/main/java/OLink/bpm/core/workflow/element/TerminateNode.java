...
public class TerminateNode extends Node {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5699282608983077403L;
	...
	public void paint(OGraphics g) {
		...
		if (this.name != null) {
			...
			if (this._iscurrent) {
				g.drawImage(_owner.getImageResource("terminate.gif"),
		...
		// java.awt.FontMetrics fm = _owner.getFontMetrics(font);
		// _iconrect.y += 10;
		// g.drawImage(_owner.getImageResource("terminate.gif"), _iconrect.x,
