...
public class DocumentWriter {
	...
	public String writeString(UAElement element, boolean xmlDecl) throws TransformerException {
		return writeString(element.getElement(), xmlDecl);
	}

	public String writeString(Element element, boolean xmlDecl) throws TransformerException {
	...
	public byte[] writeBytes(UAElement element, boolean xmlDecl) throws TransformerException {
		return writeBytes(element.getElement(), xmlDecl);
	}

	public byte[] writeBytes(Element element, boolean xmlDecl) throws TransformerException {
