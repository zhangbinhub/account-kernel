...
public class MasterSheet extends AbstractSheet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8453173997701604390L;

	private final static String HEAD_TEXT = "MasterSheet";

	private final static Color HEAD_COLOR = new Color(128, 255, 128);
	...
	public MasterSheet(ExcelMappingDiagram owner) {
		super(owner);
	}
