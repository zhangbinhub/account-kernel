...
public class EndNode extends Node {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8790175412498825670L;

	public EndNode(FlowDiagram owner) {
		super(owner);
	...
	public static void main(String[] args) {
		/*
		 * FlowDiagram fd = new FlowDiagram(); EndNode g = new EndNode(fd);
		 */
	}

	public void paint(OGraphics g) {
		if (_img == null) {
			_img = _owner.getImageResource("end.gif");
		}
	...
	public void paintMobile(OGraphics g) {
		_img = _owner.getImageResource("end_m.gif");
